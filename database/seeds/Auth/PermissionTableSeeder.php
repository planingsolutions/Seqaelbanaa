...
class PermissionTableSeeder extends Seeder
{
    ...
    //    Mainsection Permission
        $viewBackend = new Permission();
        $viewBackend->name = 'view-mainsection';
        $viewBackend->display_name = 'View Mainsection';
        $viewBackend->sort = 49;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $viewBackend = new Permission();
        $viewBackend->name = 'create-mainsection';
        $viewBackend->display_name = 'create Mainsection';
        $viewBackend->sort = 50;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $viewBackend = new Permission();
        $viewBackend->name = 'edit-mainsection';
        $viewBackend->display_name = 'Edit Mainsection';
        $viewBackend->sort = 51;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $viewBackend = new Permission();
        $viewBackend->name = 'delete-mainsection';
        $viewBackend->display_name = 'Delete Mainsection';
        $viewBackend->sort = 52;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
