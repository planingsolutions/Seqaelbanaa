...
@section('title', app_name() . ' | ' . __('labels.backend.access.Home.AboutusSecOne'))
        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    {{ __('labels.backend.access.Home.AboutusSecOne')}} <small class="text-muted">{{ __('labels.backend.access.Home.Mainsectionf.active') }}</small>
                </h4>
            </div>
            <!--col-->
        </div>
...
<div class="form-group">
                    ...
                    <div class="col-sm-12">
                    <input type="file" class="form-control" id="Images" name="Images" placeholder="{{trans('forms.Main.Placeholder.Images')}}"  data-min-files="3" style="height: calc(2.5em + 0.75rem + -4px);">
                    </div>
                </div> 
<!-- Tittle -->
                <div class="form-group">
