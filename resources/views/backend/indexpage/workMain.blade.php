...
@section('title', app_name() . ' | ' . __('labels.backend.access.Home.WorkM'))
        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    {{ __('labels.backend.access.Home.WorkM')}} <small class="text-muted">{{ __('labels.backend.access.Home.Mainsectionf.active') }}</small>
                </h4>
            </div>
            <!--col-->
        </div>
                    ...
                    <table id="Main_section" class="table">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th> {{ trans('labels.backend.access.Home.WorkMainB') }} </th>
...
// submit Button Function
    $('#CompanyForm').submit(function(e) {
            ...
            $.ajax({
            type:'POST',
            url: "{{ url('admin/Store-WeWorkMain')}}",
            data: formData,
            cache:false,
            contentType: false,
            processData: false,
