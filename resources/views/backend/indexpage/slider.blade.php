...
@section('title', app_name() . ' | ' . __('labels.backend.access.Home.slider'))
        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    {{ __('labels.backend.access.Home.slider')}} <small class="text-muted">{{ __('labels.backend.access.Home.Mainsectionf.active') }}</small>
                </h4>
            </div>
            <!--col-->
        </div>
...
<div class="form-group">
                    ...
                    <div class="col-sm-12">
                    <input type="file" class="form-control" onclick="FileDetails()" id="Images" name="Images[]" placeholder="{{trans('forms.Main.Placeholder.Images')}}"  data-min-files="3" style="height: calc(2.5em + 0.75rem + -4px);" multiple>
                    </div>
                </div> 
<!-- Tittle -->
                <div class="form-group">
...
// submit Button Function
    $('#CompanyForm').submit(function(e) {
            ...
            $.ajax({
            type:'POST',
            url: "{{ url('admin/Store-MainSlider')}}",
            data: formData,
            cache:false,
            contentType: false,
            processData: false,
