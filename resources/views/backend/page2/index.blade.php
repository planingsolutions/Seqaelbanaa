                    ...
                    <table id="Main_section" class="table">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th>{{ trans('labels.backend.access.Home.Mainsection.Paragraph') }}</th>
...
<!-- Description -->
<div class="form-group">
                    <label for="Description" class="col-sm-12 control-label">{{ trans('labels.backend.access.Home.Mainsection.Paragraph') }}</label>
                    <div class="col-sm-12">
...
<!-- Tittle -->
                <div class="form-group">
                    <label for="Tittle" class="col-sm-12 control-label">{{trans('forms.Main.Label.Tittle')}}</label>
                    <div class="col-sm-12">
                        <input type="text" class="form-control" id="Tittle" name="Tittle" placeholder="{{trans('forms.Main.Placeholder.Tittle')}}" maxlength="255" required>
                    </div>
...
<!--Main Description -->
                <div class="form-group">
                    <label for="Description" class="col-sm-12 control-label">{{trans('forms.Main.Label.Description')}}</label>
                    <div class="col-sm-12">
                        <input type="text" class="form-control" id="Description" name="Description" placeholder="{{trans('forms.Main.Placeholder.Description')}}" maxlength="255" required>
                    </div>
...
<!-- Sub Description -->
                <div class="form-group">
                    <label for="subDescription" class="col-sm-12 control-label">{{trans('forms.Main.Label.Sub Description')}}</label>
                    <div class="col-sm-12">
                        <input type="text" class="form-control" id="subDescription" name="subDescription" placeholder="{{trans('forms.Main.Placeholder.subDescription')}}" maxlength="255" required>
                    </div>
...
<script>
  ...
  $('#Main_section').DataTable({
        processing: false,
        serverSide: true,
        ajax: "{{ url('admin/MainsectionPage3') }}",
        columns: [
